...
2. Entramos en bucle For-Each, donde:
   1. Realizamos operación Copy data para cada elemento de la lista _Archivos de entrada_.
...
Estos cuatro pasos mostrados, representan los distintos tipos de artefactos para el procesamiento de datos disponibles en Fabric. Una vez comprobado el correcto funcionamiento de cada uno de ellos, se puede definir un elemento de orquestación principal. Una posibilidad sería la creación de un Pipeline de Data Factory que lanzara los elementos de la arquitectura medallion secuencialmente.
...
![image](https://github.com/fuster-10/MicrosoftFabricDemo/assets/29040162/addad0b7-6331-4a77-828a-d5e801534c09)
